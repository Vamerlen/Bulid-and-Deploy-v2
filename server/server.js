...
app.get("/crazy-deals", (req, res) => {
  res.sendFile("crazy-deals.html", { root: "public" })
});

app.get("/crazy-deals2", (req, res) => {
  res.sendFile("crazy-deals2.html", { root: "public" })
});
...
app.get('/cart', (req, res) => {
  // Redirect to the HTML cart page with cart data as query parameters
  res.redirect(`/cart.html?items=${JSON.stringify(cartItems)}`);
});
